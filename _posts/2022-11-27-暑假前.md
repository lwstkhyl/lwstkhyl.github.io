...
**1. STARsolo first-pass，重新生成SJ.out.tab**。这一步主要为了收集所有样本的junction，不以表达矩阵为主要目的
...
**2. 汇总first-pass junction，构建updated STAR index**。先从first-pass结果里选junction，再把这些junction加入STAR索引用于second-pass
...
**3. STARsolo second-pass，生成最终BAM和SJ.out.tab**
...
**7. 收集splicing junction并合并矩阵**

[代码下载](https://lwstkhyl.me/api/download/?files=%22ATACtest%2Fnew_code%22)
