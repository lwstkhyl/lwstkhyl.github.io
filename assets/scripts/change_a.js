$(document).ready(function () {
    ...
    $("main.main a").each(function (index, dom) {
        ...
        if ((!href.includes("lwstkhyl.cn") && !href.includes("lwstkhyl.xyz") && !href.includes("127.0.0.1:4000"))  //如果是站外链接，就在新页面中打开
            || ((href.includes("lwstkhyl.cn") || href.includes("lwstkhyl.xyz") || href.includes("127.0.0.1:4000")) && href.includes("upload"))) { //如果是站内的upload链接，也在新页面中打开
