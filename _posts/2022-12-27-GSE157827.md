...
- **fig_4a**：看哪些子簇在ADv-NC中明显更常见（比如某些簇在AD中更密）
...
- nner ear receptor cell differentiation/learning：因为GO是按“基因注释集合”命名的，如果基因集中恰好包含了某些在该term里出现的基因（哪怕这些基因在脑里的astro也表达），富集就可能把这个term拉出来，并不一定真的说明我的astro是inner ear细胞
