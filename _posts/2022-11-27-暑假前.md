...
- Manhattan biplot（曼哈顿图）：分别对应精神分裂症、双相情感障碍和重度抑郁障碍。横轴是基因组位置，纵轴是TWAS Z-score；灰色水平线是Bonferroni显著性阈值。这里找的特征同时包括基因和hERV，图上标注的是其中的hERV位点部分
...
- 用FOCUS在每个LD block内做TWAS fine-mapping，以找出最可能解释关联的表达特征：条件分析回答“是否独立”，回答“在同一区域多个候选表达特征中，谁更可能是因果/主解释信号”
