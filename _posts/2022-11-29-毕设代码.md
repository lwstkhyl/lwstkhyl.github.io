...
write.csv(herv_map, file = "/public/home/GENE_proc/wth/GSE157827/metadata/hERV_locus2family.csv", row.names = F)
```
...
herv_map <- read.csv("/public/home/GENE_proc/wth/GSE157827/metadata/hERV_locus2family.csv")
...
saveRDS(
  astro, 
  file = "/public/home/GENE_proc/wth/GSE157827/my_data/GSE157827_astro.rds", 
  compress = "xz"
)
saveRDS(
  excit, 
  file = "/public/home/GENE_proc/wth/GSE157827/my_data/GSE157827_excit.rds", 
  compress = "xz"
)
saveRDS(
  oligo, 
  file = "/public/home/GENE_proc/wth/GSE157827/my_data/GSE157827_oligo.rds", 
  compress = "xz"
)
saveRDS(
  inhib, 
  file = "/public/home/GENE_proc/wth/GSE157827/my_data/GSE157827_inhib.rds", 
  compress = "xz"
)
```
