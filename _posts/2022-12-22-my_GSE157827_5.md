...
主要思路：在Oligo里面做翻译相关基因的相关性，在mic里面做免疫的，具体计算方法类似于之前做的线性拟合。基因就从GO结果里选某个功能对应的基因，在细胞类型和亚群层面都试一试
...
注意TE在免疫系统中的功能，其增强子调控网络如何计算； 注意“由外显子和TE序列拼接形成的非经典转录本（JETs）是肿瘤相关抗原的一个新来源” 是否也是神经系统疾病标志物
