...
![平移效果1](../../../../../upload/md-image/css进阶2/平移效果1.png "平移效果1"){:width=100px height=100px} -> ![平移效果2](../../../../../upload/md-image/css进阶2/平移效果2.png "平移效果2"){:width=100px height=100px}
...
例：双开门效果--两张图片横向放置：![双开门1](../../../../../upload/md-image/css进阶2/双开门1.png "双开门1"){:width=50px height=50px}

鼠标放上去时，两张图片分别向左/右移动：![双开门2](../../../../../upload/md-image/css进阶2/双开门2.png "双开门2"){:width=50px height=50px}

最后显示出下层图片：![双开门3](../../../../../upload/md-image/css进阶2/双开门3.png "双开门3"){:width=50px height=50px}
...
![时钟初始](../../../../../upload/md-image/css进阶2/时钟初始.png "时钟初始"){:width=100px height=100px}
...
![滚动的轮胎](../../../../../upload/md-image/css进阶2/滚动的轮胎.png "滚动的轮胎"){:width=70px height=70px}
...
![缩放1](../../../../../upload/md-image/css进阶2/缩放1.png "缩放1"){:width=150px height=150px}

当鼠标移到图片上时--

![缩放2](../../../../../upload/md-image/css进阶2/缩放2.png "缩放2"){:width=150px height=150px}
...
初始状态![按钮缩放1](../../../../../upload/md-image/css进阶2/按钮缩放1.png "按钮缩放1"){:width=75px height=75px}

当鼠标移到图片上时![按钮缩放2](../../../../../upload/md-image/css进阶2/按钮缩放2.png "按钮缩放2"){:width=75px height=75px}->![按钮缩放3](../../../../../upload/md-image/css进阶2/按钮缩放3.png "按钮缩放3"){:width=75px height=75px}
...
![倾斜初始](../../../../../upload/md-image/css进阶2/倾斜初始.png "倾斜初始"){:width=75px height=75px}->![倾斜效果](../../../../../upload/md-image/css进阶2/倾斜效果.png "倾斜效果"){:width=75px height=75px}

#### 渐变

多个颜色逐渐变化的效果，一般用于设置盒子背景

分为线性渐变（从一端向另一端）![线性渐变](../../../../../upload/md-image/css进阶2/线性渐变.png "线性渐变"){:width=75px height=75px}

和径向渐变（从中心向四周）![径向渐变](../../../../../upload/md-image/css进阶2/径向渐变.png "径向渐变"){:width=75px height=75px}
...
![线性渐变例1](../../../../../upload/md-image/css进阶2/线性渐变例1.png "线性渐变例1"){:width=75px height=75px}
...
![线性渐变例2](../../../../../upload/md-image/css进阶2/线性渐变例2.png "线性渐变例2"){:width=75px height=75px}

---

例：为图片添加渐变背景，使图片下部的文字更加清晰

![线性渐变案例效果1](../../../../../upload/md-image/css进阶2/线性渐变案例效果1.png "线性渐变案例效果1"){:width=75px height=75px}->![线性渐变案例效果2](../../../../../upload/md-image/css进阶2/线性渐变案例效果2.png "线性渐变案例效果2"){:width=75px height=75px}
...
1. 
    ...
    ![径向渐变效果1](../../../../../upload/md-image/css进阶2/径向渐变效果1.png "径向渐变效果1"){:width=75px height=75px}
...
2. 
    ...
    ![径向渐变效果2](../../../../../upload/md-image/css进阶2/径向渐变效果2.png "径向渐变效果2"){:width=75px height=75px}
...
3. 为按钮添加高光效果：
    ...
    ![径向渐变效果3](../../../../../upload/md-image/css进阶2/径向渐变效果3.png "径向渐变效果3"){:width=50px height=50px}
    ...
    ![径向渐变效果4](../../../../../upload/md-image/css进阶2/径向渐变效果4.png "径向渐变效果4"){:width=50px height=50px}
...
![视距](../../../../../upload/md-image/css进阶2/视距.png "视距"){:width=150px height=150px}
...
![视距效果1](../../../../../upload/md-image/css进阶2/视距效果1.png "视距效果1"){:width=100px height=100px}->![视距效果2](../../../../../upload/md-image/css进阶2/视距效果2.png "视距效果2"){:width=100px height=100px}
...
![X轴旋转1](../../../../../upload/md-image/css进阶2/X轴旋转1.png "X轴旋转1"){:width=100px height=100px}->![X轴旋转2](../../../../../upload/md-image/css进阶2/X轴旋转2.png "X轴旋转2"){:width=100px height=100px}

角度值为正数时图片上端向屏幕内转，反之外转

为父级元素添加透视属性，可以更清晰地查看图片是向哪个方向旋转：

![X轴旋转3](../../../../../upload/md-image/css进阶2/X轴旋转3.png "X轴旋转3"){:width=100px height=100px}
...
![Y轴旋转](../../../../../upload/md-image/css进阶2/Y轴旋转.png "Y轴旋转"){:width=100px height=100px}
...
![立体呈现1](../../../../../upload/md-image/css进阶2/立体呈现1.png "立体呈现1"){:width=200px height=200px}

设置后：

![立体呈现2](../../../../../upload/md-image/css进阶2/立体呈现2.png "立体呈现2"){:width=200px height=200px}

---

例：3D翻转

![3D翻转1](../../../../../upload/md-image/css进阶2/3D翻转1.png "3D翻转1"){:width=50px height=50px}->![3D翻转2](../../../../../upload/md-image/css进阶2/3D翻转2.png "3D翻转2"){:width=100px height=100px}
...
- 定位两个面
    ...
    ![3D翻转定位](../../../../../upload/md-image/css进阶2/3D翻转定位.png "3D翻转定位"){:width=100px height=100px}
...
![3D翻转初始效果](../../../../../upload/md-image/css进阶2/3D翻转.png "3D翻转"){:width=50px height=50px}
...
在判断橙色面的位移时，我们应该面向橙色，因此![橙色面位移](../../../../../upload/md-image/css进阶2/橙色面位移.png "橙色面位移"){:width=50px height=50px}实际上是橙色面Z轴的位移；

而![绿色面位移](../../../../../upload/md-image/css进阶2/绿色面位移.png "绿色面位移"){:width=50px height=50px}实际上是绿色面Z轴的位移。
...
![走马灯1](../../../../../upload/md-image/css进阶2/走马灯1.png "走马灯1"){:width=50px height=50px}->![走马灯2](../../../../../upload/md-image/css进阶2/走马灯2.png "走马灯2"){:width=50px height=50px}
...
![无缝动画原理1](../../../../../upload/md-image/css进阶2/无缝动画原理1.png "无缝动画原理1"){:width=75px height=75px}

↓

![无缝动画原理2](../../../../../upload/md-image/css进阶2/无缝动画原理2.png "无缝动画原理2"){:width=75px height=75px}

↓

![无缝动画原理3](../../../../../upload/md-image/css进阶2/无缝动画原理3.png "无缝动画原理3"){:width=75px height=75px}
...
![精灵动画](../../../../../upload/md-image/css进阶2/精灵动画.png "精灵动画"){:width=30px height=30px}
...
![多组动画1](../../../../../upload/md-image/css进阶2/多组动画1.png "多组动画1"){:width=50px height=50px}

![多组动画2](../../../../../upload/md-image/css进阶2/多组动画2.png "多组动画2"){:width=50px height=50px}

![多组动画3](../../../../../upload/md-image/css进阶2/多组动画3.png "多组动画3"){:width=50px height=50px}
